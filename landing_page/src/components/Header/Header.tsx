  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-center">
      ...
      <div className="d-flex justify-content-center align-items-center py-1 px-3 my-1">
        <h5 className="urbanist-semibold text-white text-center mb-0">"Nós somos a <span className="color-blue-text">Nazatech</span>, inovação e desenvolvimento para todos."</h5>
      </div>
    </div>
