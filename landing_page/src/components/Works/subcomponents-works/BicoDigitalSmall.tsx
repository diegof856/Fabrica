...
const BicoDigitalSmall = () => {
  return (
    <div>
 <article className="text-white ">
        <h2 className="poppins-semibold m-0 text-center">BicoDigital</h2>
        <p className="poppins-regular text-formatting mt-2 text-center">Desenvolvemos uma plataforma para você conseguir aquela grana extra.</p>
      </article>
      <article className="text-white">
        <div className="d-flex flex-column justify-content-center align-items-center text-center">
          <h2 className="color-blue-text poppins-bold fs-5">100+ Trabalhos em Sua região</h2>
          <p className="poppins-regular text-formatting mt-2 ">
...
export default BicoDigitalSmall