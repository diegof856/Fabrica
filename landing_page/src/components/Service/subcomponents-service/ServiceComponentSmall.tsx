...
const ServiceComponentSamll = () => {
  return (
    <div>
        ...
        <p className="small poppins-regular text-formatting ">Desenvolvemos soluções digitais completas para impulsionar o seu negócio com tecnologia de ponta e design inovador.</p>
    </article>
