...
const ServiceComponentLarge = () => {
  return (
    <div>
        ...
        <p className="poppins-regular mx-auto padding_lg fs-5 text-center ">Desenvolvemos soluções digitais completas para impulsionar o seu negócio com tecnologia de ponta e design inovador.</p>
    </article>
